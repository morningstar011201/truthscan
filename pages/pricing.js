...
const PLANS = [
  ...
  },
  {
    ...
    color: "#00ffe0",
    features: ["100 scans/month", "Full AI analysis", "Scan history", "Screenshot upload", "Priority support"],
    cta: "Get Basic",
    popular: false,
  },
  {
    ...
    color: "#a78bfa",
    features: ["250 scans/month", "Full AI analysis", "Scan history", "Screenshot upload", "Priority support", "Early features"],
    cta: "Get Standard",
    popular: true,
  },
  {
    ...
    color: "#fbbf24",
    features: ["750 scans/month", "Full AI analysis", "Scan history", "Screenshot upload", "Priority support", "Early features", "Pro badge"],
    cta: "Go Pro",
    popular: false,
  },
];
